...
const HandleLayer = ({ nodes = [], edges = [], pan = { x: 0, y: 0 }, zoom = 1, edgeTypes = {}, onDragStart, onDragMove, onDragEnd, children }) => {
  ...
  useEffect(() => {
    // Only update handle positions when nodes or edgeTypes change
    const allHandles = [];
    const handleMap = {};
